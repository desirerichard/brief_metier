...
Le développeur backend créer la partie cachée d'un site web ou d'une application web et mobile, en gérant la partie côté serveur, le stockage de l’application, ainsi que l'intégration de la base de données.
...
<details>
  ...
  <br>
    <ul>
        <li>Expertise en responsive design et mobile friendly</li>
        <li>SEO , Optimiser les sites/applications web pour les moteurs de recherche ainsi que les utilisateurs</li>
        <li>Sensibilité graphique et au design</li>
        <li>Le versionning ( git )</li>
        <li>Veille technologique et technique</li>
        <li>Travail en équipe</li>
        <li>Résoudre des problèmes tech , debug</li>
        <li>API, webservices</li>
        <li>CMS</li>
        <li>Bonne pratique de Sécurité</li>
    </ul>
</details>
...
<details>
  <summary><b>Backend Developer :</b></summary>
  <br>
    <ul>
        <li>Administration de bases de données</li>
        <li>Langages de scripting</li>
        <li>Le versionning ( git )</li>
        <li>Veille technologique et technique</li>
        <li>Travail en équipe</li>
        <li>Résoudre des problèmes tech , debug</li>
        <li>API, webservices</li>
        <li>Langages de programmation « dynamiques »</li>
        <li>Bonne pratique de Sécurité</li>
    </ul>
</details>
...
- Réseaux (linkedin, indeed, hellowork …)
- Réseau personnel
- Bouches à oreilles
...
*<a href="https://recrutement.axa.fr/nos-offres-emploi/23092344?src=JB-10141&at_type=partner&at_identifier=linkedin&at_campaign=5" target="_blank" rel="noopener noreferrer" >Stage en Développement Mobile - Wasquehal</a>* | `Mobile` | **AXA** | Wasquehal
